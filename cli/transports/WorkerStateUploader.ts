...
import { secureJitterFraction, secureJitterMs } from 'src/utils/secureJitter.js'    failures++
  ...
  private retryDelay(failures: number): number {
    ...
    const jitter = secureJitterMs(this.config.jitterMs) // SEC-FIX: crypto.randomInt()
